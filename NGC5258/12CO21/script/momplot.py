...
mom0file = imageDir + 'NGC5258_12CO21_combine_pbcor_mom0.fits'
mom1file = imageDir + 'NGC5258_12CO21_pbcor_cube_mom1.fits'
mom2file = imageDir + 'NGC5258_12CO21_pbcor_cube_mom2.fits'
...
plt.savefig(picDir + galaxy + '_' + line + '_pbcor_cube_mom1.png',
            bbox_inches='tight')
...
plt.savefig(picDir + galaxy + '_' + line + '_pbcor_cube_mom2.png',
            bbox_inches='tight')
