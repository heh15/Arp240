...
vis = '/home/heh15/workingspace/Arp240/NGC5258/12CO21/'\
...
rmsCRTF = '/home/heh15/workingspace/Arp240/NGC5258/'\
          '/12CO21/region/emission_free_54.crtf'
rmsChan = '60~69'
pblimit=0.2
...
immoments(imagename=myImage,moments=1,includepix=[4*rms,100],chans='10~60',outfile=myImage+'.mom1')

immoments(imagename=myImage,moments=2,includepix=[4*rms,100],chans='10~60',outfile=myImage+'.mom2')
