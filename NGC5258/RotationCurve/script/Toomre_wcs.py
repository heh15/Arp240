...
fitsfiles={}
fitsfiles['12CO21 mom0']=imageDir+'NGC5258_12CO21_combine_noise45_mom0.fits'
fitsfiles['12CO21 mom2']=imageDir+'NGC5258_12CO21_combine_noise45_mom2.fits'
fitsfiles['33 GHz']=imageDir+'NGC5258_33GHz_regrid.fits'
fitsfiles['Mstar']=mapDir+'mass_map_regrid.fits'

############################################################
# basic information 

galaxy='NGC 5258'
galaxy_label='NGC5258'
...
ra=204.9903125*u.degree
dec=0.8309722222222*u.degree
...
size2=960
########## private region
center_pix=[466,473] # for NGC 5258
####################
x=range(size2)
y=range(size2)
