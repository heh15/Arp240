...
fitsimage=imageDir+'NGC5258_12CO10_combine_contsub_2rms_pbcor_mom0.fits'
...
im=plt.imshow(mom0_cut,origin='lower',cmap='gist_ncar_r', norm=colors.PowerNorm(gamma=0.9))
beamellipse_pix.plot(color='black')
cbar=plt.colorbar(im)
cbar.set_label('$Jy km \dot s^{-1} beam^{-1}$')
plt.savefig(picDir+'NGC5258_12CO10_pbcor_cube_mom0.png', bbox_inches='tight',pad_inches=0.2)
