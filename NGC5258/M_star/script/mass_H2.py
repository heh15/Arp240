...
############################################################
# directory
Dir='/home/heh15/workingspace/Arp240/NGC5258/M_star/'
logDir=Dir+'log/'
workDir=Dir+'H2mass/'
imageDir=Dir+'image/'
...
Image=imageDir+'NGC5258_12CO10_combine_contsub_pbcor_mom0.fits'
...
radius = 24.86 # SDSS petrosian radius for NGC 5257 in arcsec. 
center = position 
