...
Dir='/1/home/heh15/workingspace/Arp240/NGC5258/uvtaper/'
imageDir=Dir+'image/'
picDir=Dir+'picture/'
...
outcube.write(imageDir+'12CO10/NGC5258_12CO10_uvrange_pbcor_cube.fits',overwrite=True)
...
mom0.write(imageDir+'12CO10/NGC5258_12CO10_uvrange_pbcor_cube_mom0.fits',overwrite=True)

co10mom0=mom0

### 12CO 2-1 cube processing. ###
name=imageDir+'12CO21/NGC5258_12CO21_combine_uvtaper_pbcor.fits'
imagecube=SpectralCube.read(name)
common_beam = imagecube.beams.common_beam(tolerance=1e-5)
...
## find the signal of the cube. 
outcube=cube.find_signal_in_cube(Imcube,rmscube,snr_hi=4,nchan_hi=1,nchan_lo=2)
outcube.write(imageDir+'12CO21/NGC5258_12CO21_uvtaper_pbcor_cube.fits',overwrite=True)

imcube=outcube.with_spectral_unit(u.km/u.s,velocity_convention='radio',rest_value=225.46*10**9*u.Hz)
mom0=imcube.moment(order=0)
mom0.write(imageDir+'12CO21/NGC5258_12CO21_uvtaper_pbcor_cube_mom0.fits',overwrite=True)
...
ratio.write(imageDir+'NGC5258_2110_ratio.fits', overwrite=True)
