...
'''
Apr.4th,2019
change the map to the casa5.4.4 version.
1) phase center becomes the coordinates. 
rms_12CO10=
rms_12CO21=0.0038
'''
...
vis = '/home/heh15/workingspace/Arp240/NGC5258/12CO10/'\
      'calibrated/NGC5258_combine_CO.ms.contsub'
cleanDir = '/home/heh15/workingspace/Arp240/NGC5258/'\
             'uvtaper/image/'
preName = cleanDir+'NGC5258_12CO10_combine_contsub_uvrange'
...
vis_12CO21 = '/home/heh15/workingspace/Arp240/NGC5258/'\
             '12CO21/calibrated/NGC5258_CO12_21_combine.ms/'
cleanDir = '/home/heh15/workingspace/Arp240/NGC5258/uvtaper/image/'
preName_12CO21 = cleanDir + 'NGC5258_12CO21_combine_uvtaper'
preName_12CO10 = cleanDir + 'NGC5258_12CO10_combine_uvtaper'
rmsCRTF = regionDir+'emissionFree_12CO21.crtf'
rmsChan = '60~69'
pblimit=0.2
phasecenter='J2000 13h39m57.675 0d49m51.5'
...
immoments(imagename=preName_12CO21+'.image',moments=0,includepix=[2*rms,100],chans='10~60',outfile=preName_12CO21+'.mom0')

impbcor(imagename=preName_12CO21+'.image',
        pbimage=preName_12CO21+'.pb',
        outfile=preName_12CO21+'_pbcor.image')
imcollapse(imagename=preName_12CO21+'.pb',
           axes=3,
           function="mean",
           outfile=preName_12CO21+'_mom0.pb')
impbcor(imagename=preName_12CO21+'.mom0',
        pbimage=preName_12CO21+'_mom0.pb',
        outfile=preName_12CO21+'_pbcor.mom0')
