...
fitsfiles['33 GHz']=imageDir+'NGC5258_33GHz_pbcor_smooth_co21_regrid.fits'
fitsfiles['12CO21']=imageDir+'NGC5258_12CO21_pbcor_smooth_cube_signal_mom2.fits'
fitsfiles['12CO21 mom0'] = imageDir+'NGC5258_12CO21_combine_pbcor_mom0.fits'
...
#### import the 12CO 2-1 moment 2 maps. 
wcs, data=fits_import(fitsfiles['12CO21 mom0'])
contour_wcs_cut, contour_cut=cut_2d(data, center_point, size, wcs)
...
filename = logDir+'NGC5258_derived.txt'
