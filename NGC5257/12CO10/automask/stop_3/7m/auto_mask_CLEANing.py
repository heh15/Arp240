...
if 'casapy.py' not in sys.argv[-1]:
    ...
    vis = '/home/heh15/practice/Arp240/2015.1.00804.S/' \
          ...
          'workingspace/automask/7m/arp240_7m_CO.ms/'
    cleanDir = '/home/heh15/practice/Arp240/2015.1.00804.S/' \
               'science_goal.uid___A001_X2d6_X261/' \
               'group.uid___A001_X2d6_X262/member.uid___A001_X2d6_X265/' \
               'workingspace/automask/7m/run/'
    preName = cleanDir + 'NGC_5257_CO10_7m_auto'
    field = '0'
    antenna = ''
    phasecenter = None
    mode = 'velocity'
    ...
    rmsCRTF = '/1/home/heh15/practice/Arp240/2015.1.00804.S/' \
              ...
              'member.uid___A001_X2d6_X265/workingspace/automask/7m/' \
              'emission_free.crtf'
    rmsChan = '21'
    minpb=0.2
