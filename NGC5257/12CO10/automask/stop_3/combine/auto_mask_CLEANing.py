...
delmod('arp240_combine_CO.ms')
# if running from outside of CASA CLI
if 'casapy.py' not in sys.argv[-1]:
    # intialize CLEAN parameters
    vis = '/home/heh15/practice/Arp240/2015.1.00804.S/' \
          'science_goal.uid___A001_X2d6_X261/' \
          'group.uid___A001_X2d6_X262/member.uid___A001_X2d6_X265/' \
          'workingspace/test_automask/arp240_combine_CO.ms/'
    cleanDir = '/home/heh15/practice/Arp240/2015.1.00804.S/' \
               'science_goal.uid___A001_X2d6_X261/' \
               'group.uid___A001_X2d6_X262/member.uid___A001_X2d6_X265/' \
               'workingspace/test_automask/natversion/'
    preName = cleanDir + 'NGC_5257_CO10_combine_Nat'
    field = '0'
    antenna = ''
    phasecenter = None
    mode = 'velocity'
    ...
    stop = 3.0
    beamMin = 0.5
    rmsCRTF = '/1/home/heh15/practice/Arp240/2015.1.00804.S/' \
              'science_goal.uid___A001_X2d6_X261/group.uid___A001_X2d6_X262/' \
              'member.uid___A001_X2d6_X265/workingspace/test_automask/' \
              'emission_free.crtf'
    rmsChan = '21'
    minpb=0.2
