...
gname = 'NGC_5257' 
outfolder = './NGC5257_12CO21_output/' 
	...
	for j in range (0,3): 
		for i in range (0,5): 
			...
			if (j==i==0): 
				...
				bmaj, bmin, bpa = 10.01/float(xmax-xmin), 5.5/float(ymax-ymin),-64.279
...
xminpv, xmaxpv = np.floor(crpixpv-1-152), np.ceil(crpixpv-1 +152) 
