...
##################################################
# main program
Dir='/1/home/heh15/workingspace/Arp240/NGC5257/scatter/'
picDir=Dir+'picture/'
imageDir=Dir+'image/'
logDir=Dir+'log/'

# regbin the image with 5 pixels together.
image_mom0=imageDir+'NGC5257_12CO21_combine_5bin_mom0.fits'
image_mom2=imageDir+'NGC5257_12CO21_combine_5bin_mom2.fits'
...
## exclude the point within 2.5 arcsec.
...
alpha1=5.77*np.power(disk_masked,2)/x*40/235
alpha2=5.77*np.power(core_masked,2)/x*40/235
