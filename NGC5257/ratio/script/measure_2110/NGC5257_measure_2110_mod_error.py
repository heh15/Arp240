...
imageDir=Dir+'image/'
logDir=Dir+'log/'
ratioDir=imageDir+'ratio/2110/uvtaper_5rms/'
...
anomaly_sky=read_ds9(filename,errors='warn')[0]
anomaly_pix=anomaly_sky.to_pixel(wcs)
anomaly_masked=Apmask_convert(anomaly_pix, data10_masked)
rms=0.0016
chan_width=10
flux_12CO10=flux_mask_get(anomaly_masked,rms,chans,chan_width)[0]
uncertainty_12CO10=flux_mask_get(anomaly_masked,rms,chans, chan_width)[1]
...
center_masked=Apmask_convert(center_pix, data10_masked)
rms=0.0016
chan_width=10
...
anomaly_pix=anomaly_sky.to_pixel(wcs)
anomaly_masked=Apmask_convert(anomaly_pix, data21_masked)
rms=0.0046
chan_width=10
flux_12CO21=flux_mask_get(anomaly_masked,rms,chans,chan_width)[0]
uncertainty_12CO21=flux_mask_get(anomaly_masked,rms,chans, chan_width)[1]
...
center_pix=center_sky.to_pixel(wcs)
center_masked=Apmask_convert(center_pix, data21_masked)
rms=0.0046
chan_width=10
flux_12CO21=flux_mask_get(center_masked,rms,chans,chan_width)[0]
uncertainty_12CO21=flux_mask_get(center_masked,rms,chans, chan_width)[1]
...
co32_sky=read_ds9(filename,errors='warn')[0]
co32_pix=co32_sky.to_pixel(wcs)
co32_masked=Apmask_convert(co32_pix, data21_masked)
rms=0.0046
chan_width=10
flux_12CO21=flux_mask_get(co32_masked,rms,chans,chan_width)[0]
uncertainty_12CO21=flux_mask_get(co32_masked,rms,chans, chan_width)[1]
ratio_table['12CO21 flux']['co32']=flux_12CO21
ratio_table['12CO21 uncertainty']['co32']=uncertainty_12CO21
