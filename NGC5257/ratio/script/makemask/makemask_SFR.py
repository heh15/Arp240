...
region=regionDir+'hinge.crtf'
output=maskDir+'hinge_SFR.mask'
mask_shape(image,region,output)

region=regionDir+'center_init.crtf'
output=maskDir+'center_SFR.mask'
mask_shape(image,region,output)

region=regionDir+'south_init.crtf'
