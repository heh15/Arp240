...
fitsimage = co21_dir+'NGC5257_12CO21_combine_pbcor_mom0.fits' 
...
## import the 12CO3-2 moment 0 map
co32_dir = Dir+ 'image/12CO32/'

## import Radex regions. 
...
southwest_sky=read_ds9(filename,errors='warn')[0]
southwest_pix=southwest_sky.to_pixel(wcs_cut)
...
center_pix.plot(color=color, linewidth=2.0)
co32_pix.plot(color=color, linewidth=2.0)
if poster == 'off':
	southwest_pix.plot(color=color, linewidth=2.0)
	south_pix.plot(color=color, linewidth=2.0)
