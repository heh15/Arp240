...
### moment 0 map ###
moment0=outcube.moment(order=0)
moment0.write(imageDir+'NGC5257_12CO21_pbcor_cube_mom0.fits')
...
moment1.write(imageDir+'NGC5257_12CO21_pbcor_cube_mom1.fits')
...
plt.savefig(picDir+'NGC5257_12CO21_mom1.png')
