...
Nov 16th, 2018
The smooth doesn't work well for herschel image, the target beam is 6.0 arcsec, while the result restoring beam is about 2arcsec. Stop smoothing the herschel image.  
'''

# # smooth the herschel and galex to 6 arcsec resolution
# imsmooth(imagename='herschel_70um_header.image',
#          kernel='gauss',
#          major='6.0arcsec',
#          minor='6.0arcsec',
#          pa='0deg',
